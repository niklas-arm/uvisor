...
#define UVISOR_SVC_ID_STUPID_BACKDOOR_REGISTER UVISOR_SVC_CUSTOM_TABLE(20)
#define UVISOR_SVC_ID_STUPID_SYSTICK_REGISTER  UVISOR_SVC_CUSTOM_TABLE(21)
#define UVISOR_SVC_ID_STUPID_PENDSV_REGISTER   UVISOR_SVC_CUSTOM_TABLE(22)
#define UVISOR_SVC_ID_PAGE_MALLOC           UVISOR_SVC_CUSTOM_TABLE(23)
#define UVISOR_SVC_ID_PAGE_FREE             UVISOR_SVC_CUSTOM_TABLE(24)
